...
#define DNET_VERSION "T11.231-T14.085" /* $DVS:time$

T14.085 добавлена поддержка ipv6, теперь адрес можно задавать в виде ipv6-адрес:порт

T13.961 введён файл профиля dnet_profile.txt, из которого читаются последние аргументы
	командной строки при запуске; в команду history добавлен второй аргумент - 
	шаблон, по которому фильтруются выводимые строки истории

T13.955 исправлены ошибки сборки в Linux

T13.928 компиляция xdag в системе LDuS

T13.916 слияние с кодом dnet из проекта xdag (cheatcoin)
